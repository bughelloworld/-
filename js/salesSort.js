...
MMBuy.prototype = {
    ...
    initTab: function () {
        ...
        (function ($) {
            ...
            var html2 = '<ul class="mui-table-view"><li class="mui-table-view-cell">选项卡</li><li class="mui-table-view-cell">第二个选项卡子项-2</li><li class="mui-table-view-cell">第二个选项卡子项-3</li><li class="mui-table-view-cell">第二个选项卡子项-4</li><li class="mui-table-view-cell">第二个选项卡子项-5</li></ul>';
